...
const QualityReport = ({ qualityReport, onClose }) => {
  ...
  const handleDownloadJSON = () => {
    ...
    saveAs(dataBlob, `quality-report-${qualityReport.file_name || 'report'}-${new Date().toISOString().split('T')[0]}.json`);
  };
                ...
                {Object.entries(summary.flag_summary).map(([flag, count]) => (
                  <div key={flag} className="flag-summary-item">
                    ...
                    <div className="flag-info">
                      ...
                      <div className="flag-count">{count} points</div>
                    </div>
                  </div>
                ))}
              </div>
                        ...
                        <div className="test-details">
                          ...
                          {testData.column_results && Object.keys(testData.column_results).length > 0 && (
                            <div className="test-column-results">
                              ...
                              {Object.entries(testData.column_results).map(([colName, colResult]) => (
